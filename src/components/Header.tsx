...
export const Header: React.FC = () => {
  ...
  return (
    <div className="w-screen absolute top-0 flex items-start flex-col">
      ...
      <div className="w-full h-24 bg-black justify-between flex-row flex px-20 items-center">
        <Image
      ...
      <div className="w-full h-7 mt-1 bg-black justify-center flex-row flex items-center gap-1">
